...
class EquipmentRepository {
    ...
    * */
    ...
    suspend fun getEquipmentList() : MutableList<EquipmentResponse>? {
        val response = apiService?.getAllEquipmentByNickName(UserInfo.nickName)
    ...
    suspend fun postEquipment(item: EquipmentResponse) : Int {
        val response = apiService?.postEquipment(UserInfo.nickName, item)
    ...
    suspend fun putEquipment(item: EquipmentResponse) : Int {
        val response = apiService?.putEquipment(UserInfo.nickName, item)
